...
@app.route("/notebook1")
def notebook1():
    return render_template("Drebin.html")

@app.route("/notebook2")
def notebook2():
    return render_template("Malgenome.html")

@app.route("/notebook3")
def notebook3():
    return render_template("CIC_MALDROID2020.html")
...
def predict():
    ...
    model = joblib.load('model_mal.sav')
...
def predict2():
    ...
    if predict==0:
        ...
        output='There is an No Attack Detected in the Cloud!'
